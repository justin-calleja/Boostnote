...
class StorageItem extends React.Component {
  ...
  render () {
    const { isActive, isFocused, handleButtonClick, handleContextMenu,
      folderName, folderColor, isFolded, noteCount, handleKeyDown } = this.props

    const styleName = isFocused
      ? 'folderList-item--active-focused'
      : isActive ? 'folderList-item--active' : 'folderList-item'

    return <button styleName={styleName}
